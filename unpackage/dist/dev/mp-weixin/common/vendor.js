...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"x","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
/* 5 */
/*!****************************************!*\
  !*** D:/尚硅谷/新建文件夹/实战/xcx/x/pages.json ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* 12 */
/*!********************************************!*\
  !*** D:/尚硅谷/新建文件夹/实战/xcx/x/store/index.js ***!
  \********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* 14 */
/*!***************************************************!*\
  !*** D:/尚硅谷/新建文件夹/实战/xcx/x/store/modules/home.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//唯一可以修改state地方
var mutations = {
  GETHOMEDATA: function GETHOMEDATA(state, homeData) {
    state.homeData = homeData;
  },
  GETOTHERDATA: function GETOTHERDATA(state, arr) {
    state.arr = arr;
  } };

//处理业务地方
var actions = {
  getHomeData: function getHomeData(_ref, payload) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var state, dispatch, commit, getter, result;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:state = _ref.state, dispatch = _ref.dispatch, commit = _ref.commit, getter = _ref.getter;_context.next = 3;return (
                (0, _request.request)("/getIndexData"));case 3:result = _context.sent;
              commit('GETHOMEDATA', result);
              console.log(result);case 6:case "end":return _context.stop();}}}, _callee);}))();
  },
  //获取导航后面三个数据
  getOtherData: function getOtherData(_ref2, payload) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee2() {var commit, state, dispatch, getter, result;return _regenerator.default.wrap(function _callee2$(_context2) {while (1) {switch (_context2.prev = _context2.next) {case 0:commit = _ref2.commit, state = _ref2.state, dispatch = _ref2.dispatch, getter = _ref2.getter;_context2.next = 3;return (
                (0, _request.request)("/getIndexCateList"));case 3:result = _context2.sent;
              commit('GETOTHERDATA', result);case 5:case "end":return _context2.stop();}}}, _callee2);}))();
...
/* 18 */
/*!**********************************************!*\
  !*** D:/尚硅谷/新建文件夹/实战/xcx/x/utils/request.js ***!
  \**********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.request = void 0; //封装请求,将来在仓库发请求->仓库当中->页面找仓库要数据
var request = function request(url) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};var method = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "get";
  return new Promise(function (resolve, reject) {
    ...
    uni.request({
      ...
      data: data, //携带参数
      method: method, //请求方式
      success: function success(res) {//请求成功的回调
        resolve(res.data);
      },
      fail: function fail(error) {//请求失败的回调
        reject(error);
      } });
...
/* 19 */
/*!*******************************************************!*\
  !*** D:/尚硅谷/新建文件夹/实战/xcx/x/store/modules/category.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//唯一可以修改state地方
var mutations = {
  GETCATEGORYDARA: function GETCATEGORYDARA(state, arr) {
    state.arr = arr;
  } };
...
var actions = {
  ...
  payload) {return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var commit, state, dispatch, getter, result;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:commit = _ref.commit, state = _ref.state, dispatch = _ref.dispatch, getter = _ref.getter;_context.next = 3;return (
                (0, _request.request)("/getCateGoryData"));case 3:result = _context.sent;
              commit('GETCATEGORYDARA', result);case 5:case "end":return _context.stop();}}}, _callee);}))();
  } };
...
/* 20 */
/*!*******************************************************!*\
  !*** D:/尚硅谷/新建文件夹/实战/xcx/x/store/modules/shopcart.js ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
